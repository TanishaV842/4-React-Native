...
// (obj)brings data back to the server(access to action creators as props)
...
class Main extends Component {
    // LifeCycle method calls each ActionCreator in turn
    componentDidMount() {
...
// how to gain access to the ActionCreators as props inside the Main component
